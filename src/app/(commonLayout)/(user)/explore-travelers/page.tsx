...
const ExploreTravelers = () => {
  ...
  // Sample travelers data - replace with actual API data
  const travelers = [
    {
      id: "e63bc416-e1f7-472f-92ab-2800852654df",
      name: "John Smith",
      ...
      reviewsReceived: [],
      rating: 0,
      contactNumber: "01703691605",
    },
    {
      id: "6a48e2da-7fea-4884-a031-b07714f2aa37",
      name: "Baki Rahman",
      ...
      travelInterests: ["Hiking", "Food", "Biking"],
      travelPlans: [
        {
          id: "660005f6-967b-4478-88d1-ec2152f41c42",
          destination: "Tanguar Haor, CTG",
          startDateTime: "2025-12-10T18:00:00.000Z",
          endDateTime: "2025-12-13T18:00:00.000Z",
          budgetRange: "1000 - 1100",
          travelType: "FAMILY",
          itinerary: "Exploring beaches, temples and waterfalls...",
        },
      ],
      visitedCountries: ["Bangladesh"],
      reviewsGiven: [{ rating: 4 }],
      reviewsReceived: [{ rating: 4.6, comment: "Baki was very helpful." }],
      rating: 4.6,
      contactNumber: "01703691611",
    },
    {
      id: "3",
      name: "Sarah Johnson",
      ...
      travelInterests: ["Photography", "Adventure", "Hiking"],
      travelPlans: [
        {
          id: "1",
          destination: "Cox's Bazar",
          startDateTime: "2025-12-15T00:00:00.000Z",
          travelType: "SOLO",
        },
      ],
      visitedCountries: ["Bangladesh", "Thailand", "Nepal"],
      reviewsGiven: [],
      reviewsReceived: [{ rating: 4.8 }, { rating: 5 }],
      rating: 4.9,
    ...
    },
    {
      ...
      travelInterests: ["Food", "Culture", "Photography"],
      travelPlans: [],
      visitedCountries: ["Bangladesh", "India", "Vietnam", "Japan"],
      reviewsGiven: [{ rating: 5 }],
      reviewsReceived: [{ rating: 4.7 }],
      rating: 4.7,
    ...
    },
    {
      ...
      travelInterests: ["Beach", "Swimming", "Relaxation"],
      travelPlans: [
        {
          id: "2",
      ...
      visitedCountries: ["Bangladesh", "Maldives"],
      reviewsGiven: [],
      reviewsReceived: [{ rating: 5 }],
      rating: 5,
      contactNumber: "01734567890",
    },
  ];
  ...
  const filteredTravelers = travelers
    .filter((traveler) => {
      ...
      const matchesInterest =
        ...
        traveler.travelInterests.includes(selectedInterest);
      return matchesSearch && matchesInterest;
    })
    .sort((a, b) => {
      if (sortBy === "rating") return b.rating - a.rating;
      if (sortBy === "countries")
        return b.visitedCountries.length - a.visitedCountries.length;
      return 0;
    });

  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50/30 to-purple-50/50 dark:from-slate-950 dark:via-indigo-950/30 dark:to-purple-950/50 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredTravelers.map((traveler, index) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600">
                ...
                <div className="absolute -bottom-16 left-1/2 -translate-x-1/2">
                  {traveler.profileImage ? (
                    ...
                    <div className="w-32 h-32 rounded-full border-4 border-white dark:border-slate-900 shadow-2xl bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center text-white text-3xl font-bold">
              ...
              <div className="pt-20 px-6 pb-6">
                ...
                {traveler.travelPlans.length > 0 && (
                  <div className="mb-4 p-4 bg-gradient-to-r from-slate-50 to-blue-50 dark:from-slate-800 dark:to-blue-950/20 rounded-2xl border border-slate-200 dark:border-slate-700">
                ...
                <div className="flex gap-3">
                  <button className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 hover:shadow-lg hover:scale-105 flex items-center justify-center gap-2">
                    <MessageCircle className="w-4 h-4" />
                    <span>Connect</span>
                  </button>
                  <button className="p-3 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-xl transition-all duration-300 hover:scale-105">
